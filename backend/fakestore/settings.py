...
# ---------------------------------------------------------------------------
_candidate_key = os.getenv("DJANGO_SECRET_KEY") or os.getenv("SECRET_KEY") or ""
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "apps.api.exceptions.global_exception_handler",
}
...
MIDDLEWARE = [
    ...
    "apps.api.middleware.RequestValidationMiddleware",
]
