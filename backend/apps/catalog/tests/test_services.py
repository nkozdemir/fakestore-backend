...
class FakeProductRepository:
    ...
    def set_categories(self, product: StubProduct, category_ids):
        categories = [
            ...
            if self.category_repo.get(id=cid)
        ]
...
class ProductServiceUnitTests(unittest.TestCase):
    ...
    def test_update_product(self):
        ...
        updated = self.service.update_product(
            product.id,
            {"title": "Item2", "price": "2.00", "description": "d2", "image": "i2"},
            partial=False,
        )
    ...
    def test_list_products_cache_hit(self):
        ...
        self.product_repo.create(
            title="Cached", price="9.99", description="d", image="i"
        )
    ...
    def test_cache_version_bumped_on_mutations(self):
        ...
        dto = service_cache.create_product(
            {"title": "New", "price": "1.00", "description": "", "image": ""}
        )
